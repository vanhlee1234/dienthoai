        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="{{ route('showbyView', 1) }}" class="wid-view-more">View All</a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="{{ route('showbyView', 2) }}" class="wid-view-more">View All</a>
            ...
            <div class="col-md-4">
                <div class="single-product-widget">
                    ...
                    <a href="{{ route('showbyView', 3) }}" class="wid-view-more">View All</a>
