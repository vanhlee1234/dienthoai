			...
			<form action="{{ route('register') }}" method="post">
				...
				<div class="login-fields">
					...
					<div class="field">
						...
						<input type="text" id="email" name="email" value="" placeholder="Email" class="login form-control @error('email') is-invalid @enderror" required autocomplete="email" />
						@error('email')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
					...
					<div class="field">
						...
						<input type="password" id="confirm_password" name="password_confirmation" value="" placeholder="Confirm Password" required autocomplete="new-password" class="login" />
					</div> <!-- /field -->
